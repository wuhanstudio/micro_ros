...
#ifndef MICRO_ROS_MSGS__MSG__DETAIL__ENTITY__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_
...
#endif  // MICRO_ROS_MSGS__MSG__DETAIL__ENTITY__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_

...
#ifndef TF2_MSGS__MSG__TF_MESSAGE__ROSIDL_TYPESUPPORT_MICROXRCEDDS_C_H_
#define TF2_MSGS__MSG__TF_MESSAGE__ROSIDL_TYPESUPPORT_MICROXRCEDDS_C_H_
...
#endif  // TF2_MSGS__MSG__TF_MESSAGE__ROSIDL_TYPESUPPORT_MICROXRCEDDS_C_H_

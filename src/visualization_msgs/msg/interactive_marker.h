...
#ifndef VISUALIZATION_MSGS__MSG__INTERACTIVE_MARKER_H_
#define VISUALIZATION_MSGS__MSG__INTERACTIVE_MARKER_H_
...
#endif  // VISUALIZATION_MSGS__MSG__INTERACTIVE_MARKER_H_

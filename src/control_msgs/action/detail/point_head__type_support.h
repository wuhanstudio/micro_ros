...
#ifndef CONTROL_MSGS__ACTION__DETAIL__POINT_HEAD__TYPE_SUPPORT_H_
#define CONTROL_MSGS__ACTION__DETAIL__POINT_HEAD__TYPE_SUPPORT_H_
...
#endif  // CONTROL_MSGS__ACTION__DETAIL__POINT_HEAD__TYPE_SUPPORT_H_

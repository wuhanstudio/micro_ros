...
#ifndef CONTROL_MSGS__ACTION__DETAIL__POINT_HEAD__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_
...
#endif  // CONTROL_MSGS__ACTION__DETAIL__POINT_HEAD__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_

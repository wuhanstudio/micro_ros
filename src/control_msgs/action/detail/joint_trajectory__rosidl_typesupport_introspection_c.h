...
#ifndef CONTROL_MSGS__ACTION__DETAIL__JOINT_TRAJECTORY__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_
...
#endif  // CONTROL_MSGS__ACTION__DETAIL__JOINT_TRAJECTORY__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_

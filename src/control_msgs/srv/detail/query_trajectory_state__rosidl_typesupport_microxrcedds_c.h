...
#ifndef CONTROL_MSGS__SRV__QUERY_TRAJECTORY_STATE__ROSIDL_TYPESUPPORT_MICROXRCEDDS_C_H_
...
ROSIDL_TYPESUPPORT_MICROXRCEDDS_C_PUBLIC_control_msgs
const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, control_msgs, srv, QueryTrajectoryState_Response)();
...
const rosidl_service_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, control_msgs, srv, QueryTrajectoryState)();

#ifdef __cplusplus
}
#endif

#endif  // CONTROL_MSGS__SRV__QUERY_TRAJECTORY_STATE__ROSIDL_TYPESUPPORT_MICROXRCEDDS_C_H_

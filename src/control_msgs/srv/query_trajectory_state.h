...
#ifndef CONTROL_MSGS__SRV__QUERY_TRAJECTORY_STATE_H_
#define CONTROL_MSGS__SRV__QUERY_TRAJECTORY_STATE_H_
...
#endif  // CONTROL_MSGS__SRV__QUERY_TRAJECTORY_STATE_H_

...
#ifndef CONTROL_MSGS__MSG__INTERFACE_VALUE__ROSIDL_TYPESUPPORT_MICROXRCEDDS_C_H_
...
#endif  // CONTROL_MSGS__MSG__INTERFACE_VALUE__ROSIDL_TYPESUPPORT_MICROXRCEDDS_C_H_

...
#define LIFECYCLE_MSGS__MSG__DETAIL__TRANSITION_EVENT__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_
...
#endif  // LIFECYCLE_MSGS__MSG__DETAIL__TRANSITION_EVENT__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_

...
#ifndef STD_MSGS__MSG__DETAIL__U_INT8__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_
#define STD_MSGS__MSG__DETAIL__U_INT8__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_
...
#endif  // STD_MSGS__MSG__DETAIL__U_INT8__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_

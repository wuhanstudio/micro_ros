...
#ifndef STD_MSGS__MSG__DETAIL__EMPTY__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_
#define STD_MSGS__MSG__DETAIL__EMPTY__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_
...
#endif  // STD_MSGS__MSG__DETAIL__EMPTY__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_

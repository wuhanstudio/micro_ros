...
#ifndef RCL_INTERFACES__MSG__DETAIL__PARAMETER_TYPE__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_
...
#endif  // RCL_INTERFACES__MSG__DETAIL__PARAMETER_TYPE__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_

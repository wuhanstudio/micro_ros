...
#ifndef SHAPE_MSGS__MSG__DETAIL__MESH__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_
#define SHAPE_MSGS__MSG__DETAIL__MESH__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_
...
#endif  // SHAPE_MSGS__MSG__DETAIL__MESH__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_

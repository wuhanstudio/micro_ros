...
#ifndef SHAPE_MSGS__MSG__DETAIL__MESH_TRIANGLE__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_
...
#endif  // SHAPE_MSGS__MSG__DETAIL__MESH_TRIANGLE__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_

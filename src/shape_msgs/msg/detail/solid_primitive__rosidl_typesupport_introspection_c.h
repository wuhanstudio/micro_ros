...
#define SHAPE_MSGS__MSG__DETAIL__SOLID_PRIMITIVE__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_
...
#endif  // SHAPE_MSGS__MSG__DETAIL__SOLID_PRIMITIVE__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_

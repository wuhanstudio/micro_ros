...
#ifndef DIAGNOSTIC_MSGS__MSG__DETAIL__DIAGNOSTIC_STATUS__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_
...
#endif  // DIAGNOSTIC_MSGS__MSG__DETAIL__DIAGNOSTIC_STATUS__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_

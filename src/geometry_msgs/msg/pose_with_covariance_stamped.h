...
#ifndef GEOMETRY_MSGS__MSG__POSE_WITH_COVARIANCE_STAMPED_H_
#define GEOMETRY_MSGS__MSG__POSE_WITH_COVARIANCE_STAMPED_H_
...
#endif  // GEOMETRY_MSGS__MSG__POSE_WITH_COVARIANCE_STAMPED_H_

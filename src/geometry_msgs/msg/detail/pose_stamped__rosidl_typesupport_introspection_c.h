...
#ifndef GEOMETRY_MSGS__MSG__DETAIL__POSE_STAMPED__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_
...
#endif  // GEOMETRY_MSGS__MSG__DETAIL__POSE_STAMPED__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_

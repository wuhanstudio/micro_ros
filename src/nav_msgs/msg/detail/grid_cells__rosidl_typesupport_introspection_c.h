...
#ifndef NAV_MSGS__MSG__DETAIL__GRID_CELLS__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_
#define NAV_MSGS__MSG__DETAIL__GRID_CELLS__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_

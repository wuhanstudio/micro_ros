...
#ifndef NAV_MSGS__MSG__DETAIL__PATH__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_
#define NAV_MSGS__MSG__DETAIL__PATH__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_
...
#endif  // NAV_MSGS__MSG__DETAIL__PATH__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_

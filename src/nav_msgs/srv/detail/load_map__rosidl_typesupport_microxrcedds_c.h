...
#ifndef NAV_MSGS__SRV__LOAD_MAP__ROSIDL_TYPESUPPORT_MICROXRCEDDS_C_H_
#define NAV_MSGS__SRV__LOAD_MAP__ROSIDL_TYPESUPPORT_MICROXRCEDDS_C_H_
...
#endif  // NAV_MSGS__SRV__LOAD_MAP__ROSIDL_TYPESUPPORT_MICROXRCEDDS_C_H_
